 ...
 * Variants: centered, left-aligned, text-on-image, carousel, video-play
 */
...
<?php else : ?>
    <!-- Original variants: centered, left-aligned -->
    <section class="clesk-hero clesk-hero--<?php echo esc_attr($style); ?> relative overflow-hidden bg-[var(--color-surface)] py-16 lg:py-24">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <?php if ($style === 'centered') : ?>
                ...
                <?php if ($image) : ?>
                    <div class="mt-12 lg:mt-16 mx-auto">
                        <img src="<?php echo esc_url($image['url']); ?>"
                             alt="<?php echo esc_attr($image['alt']); ?>"
                             class="rounded-2xl shadow-xl w-full h-auto object-cover"
                             loading="lazy">
            ...
            <?php elseif ($style === 'left-aligned') : ?>
                <?php if ($image) : ?>
                    <!-- Left-aligned with image: side by side -->
                ...
                <?php else : ?>
                    <!-- Left-aligned without image: text only -->
                    <div class="max-w-3xl">
                        <?php if ($headline) : ?>
                            <h1 class="clesk-heading-1">
                                <?php echo wp_kses_post($headline); ?>
