...
function clesk_render_header_footer_tab() {
    ...
    <form method="post">
        ...
        <div style="background:#f0f6fc;border:1px solid #c3daf5;border-radius:4px;padding:12px 16px;max-width:700px;">
            ...
            <p style="margin:0;"><strong>Footer Columns:</strong> The Multi-Column footer uses "Footer Column 1" and "Footer Column 2" menu locations. Create menus and assign them under Appearance &rarr; Menus.</p>
        </div>
