...
if (function_exists('acf_add_local_field_group')) {
    ...
    $all_layouts['hero'] = array(
        ...
        'sub_fields' => array(
            ...
            array(
                ...
                'return_format' => 'array',
                'preview_size' => 'medium',
                'instructions' => 'Used by: With Image, Text on Background Image, Video Play Button',
    ...
    $all_layouts['testimonials'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_tm_items', 'label' => 'Testimonials', 'name' => 'tm_items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Testimonial', 'sub_fields' => array(
                array('key' => 'field_tm_item_quote', 'label' => 'Quote', 'name' => 'tm_quote', 'type' => 'textarea', 'required' => 1),
                array('key' => 'field_tm_item_name', 'label' => 'Name', 'name' => 'tm_name', 'type' => 'text', 'required' => 1),
    ...
    $all_layouts['logo_cloud'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_lc_logos', 'label' => 'Logos', 'name' => 'lc_logos', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Logo', 'sub_fields' => array(
                array('key' => 'field_lc_logo_image', 'label' => 'Logo', 'name' => 'lc_logo', 'type' => 'image', 'return_format' => 'array', 'required' => 1),
    ...
    $all_layouts['stats'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_st_items', 'label' => 'Stats', 'name' => 'st_items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Stat', 'sub_fields' => array(
                array('key' => 'field_st_item_number', 'label' => 'Number', 'name' => 'st_number', 'type' => 'text', 'required' => 1),
                array('key' => 'field_st_item_label', 'label' => 'Label', 'name' => 'st_label', 'type' => 'text', 'required' => 1),
    ...
    $all_layouts['banner'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_bn_text', 'label' => 'Text', 'name' => 'bn_text', 'type' => 'text', 'required' => 1),
    ...
    $all_layouts['cards_grid'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_cg_cards', 'label' => 'Cards', 'name' => 'cg_cards', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Card', 'sub_fields' => array(
                ...
                array('key' => 'field_cg_card_title', 'label' => 'Title', 'name' => 'cg_title', 'type' => 'text', 'required' => 1),
    ...
    $all_layouts['team'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_team_members', 'label' => 'Members', 'name' => 'team_members', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Member', 'sub_fields' => array(
                array('key' => 'field_team_member_name', 'label' => 'Name', 'name' => 'team_name', 'type' => 'text', 'required' => 1),
    ...
    $all_layouts['steps'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_sp_items', 'label' => 'Steps', 'name' => 'sp_items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Step', 'sub_fields' => array(
                array('key' => 'field_sp_item_title', 'label' => 'Title', 'name' => 'sp_title', 'type' => 'text', 'required' => 1),
    ...
    $all_layouts['timeline'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_tl_items', 'label' => 'Events', 'name' => 'tl_items', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Event', 'sub_fields' => array(
                ...
                array('key' => 'field_tl_item_title', 'label' => 'Title', 'name' => 'tl_title', 'type' => 'text', 'required' => 1),
    ...
    $all_layouts['video'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_vid_url', 'label' => 'Video URL', 'name' => 'vid_url', 'type' => 'url', 'required' => 1),
    ...
    $all_layouts['gallery'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_gal_images', 'label' => 'Images', 'name' => 'gal_images', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Image', 'sub_fields' => array(
                array('key' => 'field_gal_item_image', 'label' => 'Image', 'name' => 'gal_image', 'type' => 'image', 'return_format' => 'array', 'required' => 1),
    ...
    $all_layouts['contact_form'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_cf_text', 'label' => 'Text', 'name' => 'cf_text', 'type' => 'wysiwyg', 'toolbar' => 'basic', 'media_upload' => 0),
            array('key' => 'field_cf_shortcode', 'label' => 'CF7 Shortcode', 'name' => 'cf_shortcode', 'type' => 'text', 'required' => 1, 'instructions' => 'Paste your Contact Form 7 shortcode here'),
    ...
    $all_layouts['pricing'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_pr_plans', 'label' => 'Plans', 'name' => 'pr_plans', 'type' => 'repeater', 'layout' => 'block', 'button_label' => 'Add Plan', 'sub_fields' => array(
                array('key' => 'field_pr_plan_name', 'label' => 'Plan Name', 'name' => 'pr_plan_name', 'type' => 'text', 'required' => 1),
    ...
    $all_layouts['map'] = array(
        ...
        'sub_fields' => array(
            ...
            array('key' => 'field_map_embed_code', 'label' => 'Embed Code', 'name' => 'map_embed_code', 'type' => 'textarea', 'required' => 1, 'instructions' => 'Paste the iframe embed code'),
